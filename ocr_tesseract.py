...
# ------------------- Initialize EasyOCR -------------------
reader = easyocr.Reader(['ch_tra'], verbose=False) # ch_sim or ch_tra 1.0058

# ------------------- Evaluation Function -------------------
def evaluate_easyocr_accuracy(reader, test_df, img_dir, max_samples=None):
...
# ------------------- Run Evaluation -------------------
cer, acc, char_acc = evaluate_easyocr_accuracy(reader, test_df, IMG_DIR)
